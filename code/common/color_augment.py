...
main_folder = Path('C:/Users/michele.wiseman/Desktop/Saliency_based_Grape_PM_Quantification-main/')
# dataset_folder = main_folder / 'NY84xPillans_18000' / 'dataset_12000'
# dataset_folder = main_folder
train_set_filepath = main_folder / 'train.hdf5'
val_set_filepath = main_folder / 'test.hdf5'
print("Train set filepath:", train_set_filepath)
print("Val set filepath:", val_set_filepath)
