"""
This script is a visualization of the result of ensembling three different models for a segmentation task. The script loads 3 datasets from 3 hdf5 files and stores the images and masks in separate arrays. Then, for each of 4 randomly selected images, the corresponding masks from each of the 3 datasets are loaded, added together, and thresholded to generate an ensemble mask. The ensemble mask and images from all three models are then plotted together and saved as a png image.
