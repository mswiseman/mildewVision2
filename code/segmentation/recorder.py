"""
This script is used to record the loss history and performance metrics of a machine learning model during training. It keeps track of the number of correctly classified samples, the total number of samples, the loss, the number of predicted infected samples, the number of ground truth infected samples, and the number of correctly classified infected samples. The metrics can be reset to zero by calling the reset method.
