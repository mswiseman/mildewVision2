...
if __name__ == "__main__":
    ...
    python inference.py                             \
            --model_type DeepLab                    \
            --loading_epoch 84                      \
            --timestamp Feb28_19-21-39_2023         \
            --dataset_path /E:/Stacked/Mapping_Population_2023/11-14-2023_5dpi/1     \
            --model_path ../../
    """
    ...
    for idx in range(images.shape[0]):
        ...
        tmp_df = pd.DataFrame([[idx, classificatin, classificatin_label, classificatin ==
                                classificatin_label, pred_infected_pixels, mask_infected_pixels, iou, dice]],
