...
def hard_thresholding(mask, mask_threshold, vmin=0, vmax=1):
    """
    Args:
    ...
    """
    mask_copy = mask.copy()
    mask_copy[mask_copy < mask_threshold] = vmin
    mask_copy[mask_copy >= mask_threshold] = vmax
...
def otsu_thresholding(mask, vmin=0, vmax=1):
    ...
    _, th1 = cv2.mask_threshold(mask_copy, vmin, vmax,
